...
class StudentListForGroup extends React.Component { 
  constructor() {
    super();
    this.state = {};
  ...
  render() {
    return (
      ...
      {/* <DataTable value={this.props.info} responsive={true} header={'Student List'} paginator={true} rows={10} rowsPerPageOptions={[5, 10, 20]}
          ...
          <Column field="studentReligion" header="Group" style={{ textAlign: 'center' }} filter={true} />       
        </DataTable> */}
    </div>
    );
  }
...
StudentListForGroup.propTypes = {

};

export default StudentListForGroup;
