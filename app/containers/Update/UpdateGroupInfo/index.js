...
import StudentListForGroup from './StudentListForGroup';
import 'font-awesome/css/font-awesome.css';
import ProcessButton from 'components/Buttons/ProcessButton';


export class UpdateGroupInfo extends React.Component {
  render() {
    ...
    if (this.props.studentInfo) {
      content = <StudentListForGroup info={this.props.studentInfo} />
    }
    ...
    return (
      <div>
        ...
        <ContentWrapper>
          ...
          <BreadCumbsForThree breadpagetitle="Student ID" breadlavel1="Student" breadlavel2="Update" breadlavel3="Group Info" />

          <div className="panel panel-default">
            <div className="panel-heading config-header">
              <div className="panel-title"> Student Group Update</div>
            </div>
...
const mapStateToProps = createStructuredSelector({
 // updategroupinfo: makeSelectUpdateGroupInfo(),
...
const withReducer = injectReducer({ key: 'updateGroupInfo', reducer });
const withSaga = injectSaga({ key: 'updateGroupInfo', saga });
